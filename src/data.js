export const placeInfo = [
  {
    ...
    headerText:
      "Emerged after the 2008 financial crash. It has proven to it's skeptics not only to be a secure public Ledger but to be the best-performing asset in the last Decade. Being up as much as 9.000.000% ",
  ...
  },
  {
    ...
    headerText:
      'The first Blockchain protocol evolved out of scientific philosophy and a research-first approach. Cardano is a decentralized social-economic system, build by a large team of expert researchers and engineers from IOHK.',
    title:
  ...
  {   
    ...
    headerText: ' Learn where to Buy, Sell and Trade your Favorite Cryptocurrency ',
    title: 'Consequuntur quo',
    description:
      'hi, ipsum dolor sit amet consectetur adipisicing elit. Assumenda illo numquam commodi nihil nam odit, minima perferendis delectus, quibusdam modi recusandae suscipit nobis cumque, veniam similique voluptas totam quasi mollitia.',
    img: '.././img/cryptoex.jpeg',
    maps:
...
},
  {
     id: 5,
      ...
      headerText: 'Keep your Coins off Exchanges. Learn to use and secure your coins! ',
